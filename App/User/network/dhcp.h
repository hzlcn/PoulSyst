...
#define EXTERN_DHCP_GW     ConfigDhcpMsg.gw
#define EXTERN_DHCP_DNS    ConfigDhcpMsg.dns
#define EXTERN_DHCP_NAME   "iweb"//Config_TcpMsg.domain
#define EXTERN_DHCP_SIP    ConfigDhcpMsg.lip
