...
DataStruct_t g_allData = {
	.temp = {
		...
		.display = {
			.err = {
				[0] = { 0x50, 0x4C, 0x43, 0xCE, 0xDE, 0xCD, 0xA8, 0xD1, 0xB6 },					// PLC无通讯
				[1] = { 0x47, 0x50, 0x53, 0xCE, 0xDE, 0xD0, 0xC5, 0xCF, 0xA2 },					// GPS无信息
				[2] = { 0xCD, 0xE2, 0xC9, 0xA8, 0xC2, 0xEB, 0xC6, 0xF7, 0xB3, 0xF6, 0xB4, 0xED }, // 外扫码器出错
				[3] = { 0xC4, 0xDA, 0xC9, 0xA8, 0xC2, 0xEB, 0xC6, 0xF7, 0xB3, 0xF6, 0xB4, 0xED },	// 内扫码器出错
				[4] = { 0xCE, 0xDE, 0xCA, 0xB3, 0xC6, 0xB7, 0xD0, 0xC5, 0xCF, 0xA2 },				// 无食品信息
				[5] = { 0xCE, 0xDE, 0xCE, 0xC0, 0xD0, 0xC7, 0xD0, 0xC5, 0xCF, 0xA2 },				// 无卫星信息
				[6] = { 0xCE, 0xDE, 0xB6, 0xA8, 0xCE, 0xBB, 0xD0, 0xC5, 0xCF, 0xA2 },				// 无定位信息
				[7] = { 0xCE, 0xB4, 0xB9, 0xD8, 0xCB, 0xF8 },                                     // 未关锁
			},
			.wTxt = {
